                ...
                <View style={{backgroundColor: colors.buttons}}>
                    <View style={{
                        ...
                        <View style={{marginLeft: 10}}>
                            <Text style={{fontWeight: 'bold', fontSize: 18, color: colors.cardBackground}}>Tan Hoang</Text>
                            <Text style={{fontSize: 14, color: colors.cardBackground}}>tanhaudue@gmail.com</Text>
                        </View>
                    </View>
                ...
                <View style={{borderRadius: 1, borderTopColor: colors.grey5}}>
                    ...
                    <View style={styles.switchText}>
                        ...
                        <View style={{paddingRight: 10}}>
                            <Switch
                                trackColor={{ false: "#767577", false: "#81b0ff" }}
                                thumbColor='#f4f3f4'
                            />
                        </View>
                    </View>
